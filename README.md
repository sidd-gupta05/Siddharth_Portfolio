...
https://siddharth-portfolio-liart.vercel.app/
✨ Features

    🎨 Interactive Design - GSAP-powered animations and smooth transitions

    ⚡ Modern Stack - Built with React, TypeScript, and Three.js

    📱 Fully Responsive - Optimized for all devices and screen sizes

    🎯 3D Elements - Interactive tech stack visualization with React Three Fiber

    💫 Smooth Scrolling - Custom horizontal scroll for project showcase
...
📞 Connect With Me
    ...
    Website: sidd_portfolio.dev

    GitHub: @sidd-gupta05

    LinkedIn: Siddharth Gupta
...
Built with ❤️ by Siddharth Gupta
